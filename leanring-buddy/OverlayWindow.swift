...
struct BlueCursorView: View {
    ...
    var body: some View {
        ZStack {
            ...
            // Onboarding guide bubble — shows step-by-step text instructions
            // near the cursor during the onboarding flow.
            if isCursorOnThisScreen && companionManager.onboardingGuideManager.showGuideBubble && !companionManager.onboardingGuideManager.guideBubbleText.isEmpty {
                Text(companionManager.onboardingGuideManager.guideBubbleText)
                    .font(.system(size: 11, weight: .medium))
                    .foregroundColor(.white)
                    ...
                    .frame(maxWidth: 260)
                    .opacity(companionManager.onboardingGuideManager.guideBubbleOpacity)
                    .position(x: cursorPosition.x + 10, y: cursorPosition.y + 45)
